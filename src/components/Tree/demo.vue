<template>
  <div class="main">
    ...
    <m-tree :source="listLazy" :lazyLoad="lazyLoad" />

    <!-- <m-tree :source="list" :lazyLoad="lazyLoad" show-checkbox ref="Atree"/ > -->
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const listLazy = ref<TreeNodeOptions[]>([]);
